...
function getConfig(env) {
  return {
    debug: true,
    devtool: env === productionEnvironment  ? '' : 'cheap-source-map', //'cheap-module-eval-source-map', // more info:https://webpack.github.io/docs/build-performance.html#sourcemaps and https://webpack.github.io/docs/configuration.html#devtool
