  ...
  render(){
    ...
    return (
      <div>
        ...
        <p>Administrador: {staff[restaurant.admin] && staff[restaurant.admin].name}</p>
        ...
        <p>Total de ordenes emitidas: {Object.keys(restaurant.orders || {}).length}</p>
        <p>Fecha de creacion: {restaurant.createdAt && format(restaurant.createdAt, 'DD/MM/YYYY')}</p>
