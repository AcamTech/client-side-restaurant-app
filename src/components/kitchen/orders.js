          ...
          <div className="grid">
            <div className="grid__item one-half">
              <button
                ...
                className="button button-border button-border--success button--block button--small"
              >
                Aceptar
              </button>
            </div>
            <div className="grid__item one-half">
              <button
                ...
                className="button button-border button-border--danger button--block button--small"
              >
                Rechazar
              </button>
            </div>
    ...
    return (
      <article className="kitchen-order" key={id} index={id}>
        <div className="kitchen-order__head">
          <h1 className="delta kitchen-order__title">
            Orden #{order.orderNumber}
          </h1>
        </div>
        <OrderItems items={items} />
        <div className="kitchen-order__buttons">{getButtons()}</div>
      </article>
    );
  }
  render() {
