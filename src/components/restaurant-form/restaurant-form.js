...
export default class RestaurantForm extends Component {
  static displayName = 'restaurant-form';
  static propTypes = {
  ...
  render() {
    var {
      fields: { id, name, address, phone, city, cellPhone },
      invalid,
      handleSubmit,
      submitting,
      registerRestaurant,
      ...
      <form
        onSubmit={handleSubmit(data => {
          this.onSubmitHandler(data)
            ...
            .then(() =>
              this.props.showLogger('Se actualizo correctamente el restaurante')
            );
        })}
      >
        <div className="panel__body">
          <div className="grid">
            ...
            <div className="grid__item one-half">
              <div className="form-group has-feedback has-feedback--reverse">
                <input
                  ...
                  {...cellPhone}
                />
                <span className="form-control-feedback icon-phone" />
              </div>
            </div>
            <div className="grid__item one-half">
              <div className="form-group has-feedback has-feedback--reverse">
            ...
            <div className="grid__item one-half">
              <div
                className={`form-group has-feedback has-feedback--reverse ${city.touched &&
                  city.error &&
                  'has-error'}`}
              >
                <input
            ...
            <div className="grid__item">
              <div
                className={`form-group has-feedback has-feedback--reverse ${address.touched &&
                  address.error &&
                  'has-error'}`}
              >
                <input
